				...
				<div class="col-md-12 column" class="jumbotron">
					<form action="do.jsp" method="POST" class="form-inline"
						...
						<div class="form-group">
							<label for="fabujigou">就读/任职学校</label><input type="text"
								maxlength="30" placeholder="请输入您所希望聘请教师所属的学校/可为空"
								class="form-control" name="fabujigou" id="fabujigou" />
						</div>
						&nbsp;

						<div class="form-group">
							<label for="fabujigou">性别</label><input type="text" maxlength="1"
								placeholder="请输入您所希望聘请教师所属的学校/可为空" class="form-control"
								name="teachersex" id="" teachersex"" />
						</div>
						&nbsp;
						<div class="form-group">
							<label for="nianji">年级</label><input type="text" maxlength="30"
								placeholder="请输入所聘请教师的所在年级" class="form-control" name="nianji"
								id="nianji" />
						</div>
						&nbsp;
						<div class="form-group">
							<label for="kemu">科目</label><input type="text" maxlength="30"
								placeholder="请输入所需辅导的科目" class="form-control" name="kemu"
								id="kemu" />
						</div>
						&nbsp; <br> <br>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="jinyan">辅导经验</label><input type="text" maxlength="30"
								placeholder="请输入带有X年的字样" class="form-control" name="jinyan"
								id="jinyan" />
						</div>
